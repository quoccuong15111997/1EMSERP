...
import com.firstems.erp.adapter.signature.SignatureItemDiffAdapter;
...
import com.firstems.erp.callback.LoadSignatureDataListCallback;
...
public class SignatureGirdFragment extends CommonFragment {
    
    private SignatureGirdViewModel mViewModel;
    private SignatureFragmentBinding signatureFragmentBinding;
    private View view;
    private SignatureItemDiffAdapter signatuneListAdapter;
    ...
    private List<SignatureItemApiResponse> modelList;
    
    public SignatureGirdFragment(BackToHomeCallback backToHomeCallback) {
    ...
    private void addControls() {
        ...
        signatuneListAdapter= new SignatureItemDiffAdapter(modelList);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(SignatureGirdViewModel.class);
        mViewModel.getSignatureModelMutableLiveData().observe(getViewLifecycleOwner(), new Observer<List<SignatureItemApiResponse>>() {
            @Override
            public void onChanged(List<SignatureItemApiResponse> signatureItemApiResponses) {
                signatuneListAdapter.setData(signatureItemApiResponses);
    ...
    public void onResume() {
        ...
        mViewModel.loadDataSignatureResume(filterModel, new LoadSignatureDataListCallback() {
            @Override
            public void onLoaded(List<SignatureItemApiResponse> models) {
                signatuneListAdapter.setData(models);
            }
        });
    }
    @Override
