...
public class CameraUIKitActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_u_i_kit);
        ...
        permissionsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                cameraView.requestPermissions(CameraUIKitActivity.this);
            }
        });
