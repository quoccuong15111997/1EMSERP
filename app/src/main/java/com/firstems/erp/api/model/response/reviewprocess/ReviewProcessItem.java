 ...
 */
public class ReviewProcessItem implements Serializable {
    ...
    private List<ReviewProcessDetail> details;
    @SerializedName("DCMNFILE")
    private List<DocumentFile> fileList;

    public ReviewProcessItem() {
    }
    ...
    public List<ReviewProcessDetail> getDetails() {
        return details;
    }

    public void setDetails(List<ReviewProcessDetail> details) {
        this.details = details;
    }

    public List<DocumentFile> getFileList() {
        return fileList;
    }
