...
public class LoginLayoutTypeFlatBindingImpl extends LoginLayoutTypeFlatBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.textInputEditText, 4);
        sViewsWithIds.put(R.id.textInputEditText2, 5);
        sViewsWithIds.put(R.id.chkRemember, 6);
        sViewsWithIds.put(R.id.button2, 7);
        sViewsWithIds.put(R.id.textView56, 8);
    }
    // views
    // variables
    // values
