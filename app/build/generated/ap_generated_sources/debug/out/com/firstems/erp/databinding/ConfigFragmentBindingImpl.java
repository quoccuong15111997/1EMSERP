...
public class ConfigFragmentBindingImpl extends ConfigFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.include11, 20);
    ...
    private boolean onChangeUi(com.firstems.erp.viewmodel.config.ConfigUIBindingModel Ui, int fieldId) {
        ...
        else if (fieldId == BR.switchPendding) {
            synchronized(this) {
                    mDirtyFlags |= 0x800L;
            }
            return true;
    ...
    protected void executeBindings() {
        ...
        java.lang.String uiSwitchPendding = null;
        ...
        if ((dirtyFlags & 0x1fffffL) != 0) {
            ...
            if ((dirtyFlags & 0x100801L) != 0) {

                    if (ui != null) {
                        // read ui.switchPendding
                        uiSwitchPendding = ui.getSwitchPendding();
                    }
            }
            if ((dirtyFlags & 0x101001L) != 0) {
        ...
        if ((dirtyFlags & 0x100801L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView11, uiSwitchPendding);
        }
        if ((dirtyFlags & 0x101001L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView12, uiSwitchDone);
        }
        if ((dirtyFlags & 0x104001L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView14, uiSwitchInfoApprove);
        }
        if ((dirtyFlags & 0x110001L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView16, uiSwitchBySession);
        }
        if ((dirtyFlags & 0x120001L) != 0) {
            // api target 1
    ...
    /* flag mapping
        ...
        flag 11 (0xcL): ui.switchPendding
        flag 12 (0xdL): ui.switchDone
        flag 13 (0xeL): ui.titleApproveSetiing
        flag 14 (0xfL): ui.switchInfoApprove
        flag 15 (0x10L): ui.titleAskPermistion
        flag 16 (0x11L): ui.switchBySession
        flag 17 (0x12L): ui.switchWork
        flag 18 (0x13L): ui.buttonSave
        flag 19 (0x14L): ui.buttonCancel
        flag 20 (0x15L): null
    flag mapping end*/
    //end
}