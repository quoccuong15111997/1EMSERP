...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_ADVANCEPROPOSALFORMFRAGMENT = 3;

  private static final int LAYOUT_ADVANCEPROPOSALLAYOUT = 4;

  private static final int LAYOUT_APPROVEDETAILFRAGMENT = 5;

  private static final int LAYOUT_APPROVEDFRAGMENT = 6;

  private static final int LAYOUT_ASKPERMISSIONFRAGMENT = 7;

  private static final int LAYOUT_ASKPERMISSIONINFOFRAGMENT = 8;

  private static final int LAYOUT_BILLPAYMENTFRAGMENT = 9;

  private static final int LAYOUT_BILLPAYMENTREQUESTFRAGMENT = 10;

  private static final int LAYOUT_BUSINESSREGISTRATIONFRAGMENT = 11;

  private static final int LAYOUT_BUSINESSREGISTRATIONINFOFRAGMENT = 12;

  private static final int LAYOUT_CAMERAUIKITFRAGMENT = 13;
